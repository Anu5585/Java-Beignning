...
public class MyTest extends ApplicationTest {
    ...
    public void start(Stage stage)throws Exception{
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("custom-bmi.fxml"));
    ...
    public void should_calculate_BMI_english_system(){
        ...
        FxAssert.verifyThat("#bmiOutput", LabeledMatchers.hasText("22.45996044721897"));
...
//    }
    ...
    public void should_calculate_BMI_metric_system(){
        ...
        this.clickOn(english).type(KeyCode.TAB);
        this.clickOn("#btnCalc");
        FxAssert.verifyThat("#bmiOutput", LabeledMatchers.hasText("21.438228237798796"));
        FxAssert.verifyThat("#bmiCategory", LabeledMatchers.hasText("Normal Weight"));
        //weight (kg) 67
        //height (cm) 176.784
        //21.438228237798789
